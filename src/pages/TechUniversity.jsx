...
const TechUniversity = () => {
    const data = universities.tech;
        ...
        <div className="min-h-screen bg-[#030712] text-white font-sans selection:bg-blue-500/30">
            ...
            <div className="relative z-10 container mx-auto px-4 sm:px-6 py-8 sm:py-12 grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-[20%] right-[0%] w-[40%] h-[40%] bg-blue-900/10 rounded-full blur-[120px]" />
                </div>
                ...
                <div className="lg:col-span-2 relative">
                    ...
                    <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
                        ...
                        <a
                            href="/JAIS-Institute-Brochure.pdf"
                            download="JAIS-Institute-Brochure.pdf"
